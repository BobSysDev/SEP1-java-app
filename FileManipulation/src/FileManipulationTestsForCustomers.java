...
public class FileManipulationTestsForCustomers
{
  public static void main(String[] args)
  {
    ...
    try
    {
      binaryFileInterface.writeCustomerList("customerDB.bin", customerList);
    ...
    try{
      retrievedCustomerList = binaryFileInterface.readCustomerList("customerDB.bin");
