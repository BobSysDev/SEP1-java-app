...
public class IndustrialXMLReaderWriter
{
  ...
  public static IndustrialProject read(ArrayList<String> lines){
    ...
    IndustrialProject industrialProject = new IndustrialProject(title, budget, budgetEstimate, timeInterval, timeEstimate, manHours, manHoursEstimate, projectID, isArchived, "", "", size, type);
    industrialProject.setCustomer(customer);
