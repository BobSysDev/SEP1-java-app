...
public class FileManipulationTestsForProjects
{
  public static void main(String[] args)
  {
    ...
    ResidentialProject residentialProject = new ResidentialProject("This guy's house", 420.25, 500, 5, 7, 540, 500, 0, false, "none", "rock and stone", 120, 1, 2, 1, true, "house", "01.02.2021", customerA);
    CommercialProject commercialProject = new CommercialProject("Ikea Horsens", 123456, 5, 12, 9, 5200, 800, 0, true, "none", "mostly concrete", 69420, "Retail store", "03.02.2021", customerA);
