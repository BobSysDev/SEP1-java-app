...
public class FileManipulationTestsForProjectsXML
{
  public static void main(String[] args)
  {
    ...
    ResidentialProject residentialProject = new ResidentialProject(
        "This guy's house", 420.25, 500, 5, 7, 540, 500, 0, false, "none",
        "rock and stone", 120, 1, 2, 1, true);
    CommercialProject commercialProject = new CommercialProject("Ikea Horsens",
        123456, 5, 12, 9, 5200, 800, 0, false, "none", "mostly concrete", 69420,
        "Retail store");
    IndustrialProject industrialProject = new IndustrialProject("The factory",
        123456, 5, 12, 9, 5200, 800, 0, false, "none", "mostly concrete", 69420,
        "Factory");
    RoadConstructionProject roadConstructionProject = new RoadConstructionProject(
        "The road", 123456, 5, 12, 9, 5200, 800, 0, false, "none", "asphalt",
        2000, 10, 2, "mountains");
    ...
    catch (IOException e)
    {
      System.out.println(
        ...
        System.out.println(retrievedList.getProject(2).getProjectID());
        ...
        System.out.println(retrievedList.getProject(3).getProjectID());
